...
class BaseDataLoader(DataLoader):
    ...
    def __init__(self, train_dataset, batch_size, shuffle,
                 validation_split: float, num_workers, pin_memory,
        ...
        self.n_samples = len(train_dataset) \
            if val_dataset is None else len(train_dataset) + len(val_dataset)
        self.init_kwargs = {
    ...
    def _split_sampler(self, split) -> Union[Tuple[None, None],
